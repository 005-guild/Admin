				...
				<div class="row data-type">
					...
					<div class="col-md-4 data">
						<div class="input-group date">
							...
							<input type="text" class="form-control pull-right"
								...
								value="<fmt:formatDate value="${orders.orderTime }" pattern="yyyy-MM-dd"/>">
						</div>
					</div>
					...
					<div class="col-md-4 data">
						<div class="input-group date">
							...
							<input type="text" class="form-control pull-right"
								id="datepicker-a6" value="<fmt:formatDate value="${orders.product.departureTime}" pattern="yyyy-MM-dd"/>"
								readonly="readonly">
						</div>
					</div>
			...
			<!--联系人信息/--> <!--费用信息--> <c:if test="${orders.orderStatus==1}">
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data text">在线支付-${orders.payType==0?'微信':'支付宝'}</div>
